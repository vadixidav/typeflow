...
//! A cast is a declarative statement of explicit conversion from an,
...
//! conversions now and `d(a b c)` is uncessary.
//!
...
/// An explicit conversion from one expression to a series of static types.
struct Cast {}
